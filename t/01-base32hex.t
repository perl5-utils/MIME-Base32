...
can_ok('MIME::Base32', (
	...
	qw(encode_09AV decode_09AV encode decode),
...
is(MIME::Base32::encode($string),$encoded_hex, 'encode: Got the right response');
is(MIME::Base32::decode($encoded_hex),$string, 'decode: Got the right response');
